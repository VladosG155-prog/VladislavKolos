...
class ProductItem extends React.Component {
	render() {
		...
		const [{ amount }] = this.props.prices.filter((item) => item.currency.symbol === symbol);
		return (
			<div className="productCard">
				<div className="imageCard">
					{!this.props.inStock && <div className="notStock">OUT OF STOCK</div>}
					<img src={this.props.gallery[0]} alt={this.props.id} />
				</div>
				<h2>
